            ...
            <form id="attendanceForm">
                ...
                <div class="flex items-center gap-3">
                    <button type="submit" id="btnSubmit"
                        class="flex-1 px-6 py-3 bg-gradient-to-r from-blue-800 to-blue-700 text-white font-semibold rounded-lg
                        hover:from-blue-800 hover:to-blue-900 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2
