    ...
    <form class="section-save-form" action="{{ route('employee.edit.documents', $employee->id) }}" enctype="multipart/form-data">
        ...
        <div class="bg-white border border-slate-200 rounded-2xl shadow-sm p-8">
            ...
            <button type="button" id="add-document"
                class="mt-6 w-full inline-flex items-center justify-center gap-2 rounded-xl border-2 border-dashed border-sky-300 px-5 py-3 text-sm font-semibold text-sky-600 hover:border-bg-blue-900 hover:bg-sky-50 transition-all">
