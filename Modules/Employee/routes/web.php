...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Employee Profile Route (read-only, accessible with employee view permission)
    Route::get('employees/{id}/profile', [EmployeeController::class, 'profile'])->name('employee.profile');

    // Employee edit/update/delete routes - protected by employee-list-action-access permission
    Route::middleware('permission:employee-list-action-access')->group(function () {
