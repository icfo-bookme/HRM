        ...
        <div class="bg-white border border-slate-200 shadow-sm rounded-3xl p-8">
            ...
            <form method="POST" action="{{ route('employee.store.step1') }}" enctype="multipart/form-data"
                ...
                <div class="flex justify-end pt-4 border-t border-slate-200">
                    <button type="submit"
                        class="inline-flex items-center justify-center rounded-2xl bg-blue-900 px-6 py-3 text-sm font-semibold text-white transition hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                        Next Step &rarr;
                    </button>
                </div>
            </form>
