            ...
            <form method="POST" action="{{ route('employee.store.step5') }}" enctype="multipart/form-data">
                ...
                <div class="mt-6 mb-8">
                    <button type="button" id="add-document"
                        class="group inline-flex items-center gap-2.5 rounded-xl border-2 border-dashed border-sky-300 px-5 py-3 text-sm font-semibold text-sky-600 hover:border-bg-blue-900 hover:bg-sky-50 transition-all duration-200 w-full justify-center">
                ...
                <div class="flex justify-between items-center pt-6 border-t border-slate-200">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button type="submit"
                            class="inline-flex items-center justify-center rounded-xl bg-blue-900 px-6 py-2.5 text-sm font-semibold text-white transition hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-bg-blue-900 focus:ring-offset-2 shadow-sm">
                            Next Step
