...
<aside id="sidebar" class="w-52 bg-white border-r border-gray-200 flex flex-col flex-shrink-0 z-30 overflow-hidden">
    ...
    <!-- Logo -->
    <div class="h-[60px] bg-blue-900 flex items-center justify-between px-3.5 border-b border-blue-300 flex-shrink-0">
    ...
    {{ request()->routeIs('dashboard') ? 'bg-blue-900 text-white active' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-800' }}"
            data-label="Dashboard">
            <i class="fas fa-th-large w-4 text-center flex-shrink-0 text-base {{ request()->routeIs('dashboard') ? 'bg-blue-900 text-white active' : 'text-blue-800' }}"></i>
        ...
        @permission('employees.view')
            ...
            <div class="mb-0.5">
                <button
                    ...
                    <i class="fas fa-users w-4 text-center flex-shrink-0 text-base text-blue-800"></i>
        ...
        @permission('shifts.view')
            ...
            <a href="/shifts"
                ...
                data-label="Shifts">
                <i class="fas fa-clock w-4 text-center flex-shrink-0 text-base text-blue-800"></i>
        ...
        @permission('notices.view')
            ...
            <div class="mb-0.5">
                <button
                    ...
                    <i class="fa-solid fa-bullhorn w-4 text-center flex-shrink-0 text-base text-blue-800"></i>
        ...
        @permission('leave.apply')
            ...
            <div class="mb-0.5">
                <button
                    ...
                    <i class="fas fa-umbrella-beach w-4 text-center flex-shrink-0 text-base text-blue-800"></i>
        ...
        @permission('holidays.view')
            ...
            <div class="mb-0.5">
                <button
                    ...
                    <i class="fas fa-calendar-day w-4 text-center flex-shrink-0 text-base text-blue-800"></i>
        ...
        @permission('reports.attendance')
            ...
            <div class="mb-0.5">
                <button
                    ...
                    <i class="fas fa-chart-bar w-4 text-center flex-shrink-0 text-base text-blue-800"></i>
        ...
        @permission('kpi.dashboard')
            ...
            <div class="mb-0.5">
                <button
                    ...
                    <i class="fas fa-trophy w-4 text-center flex-shrink-0 text-base text-blue-800"></i>
        ...
        @permission('salary.components')
            ...
            <div class="mb-0.5">
                <button
                    ...
                    <i class="fas fa-money-bill-wave w-4 text-center flex-shrink-0 text-base text-blue-800"></i>
        ...
        @permission('loan.apply')
            ...
            <div class="mb-0.5">
                <button
                    ...
                    <i class="fas fa-hand-holding-usd w-4 text-center flex-shrink-0 text-base text-blue-800"></i>
        ...
        @permission('settings.users')
            ...
            <div class="mb-0.5">
                <button
                    ...
                    <i class="fas fa-cog w-4 text-center flex-shrink-0 text-base text-blue-800"></i>
        ...
        @permission('admin.company')
            <div class="mb-0.5">
                <button
                    ...
                    <i class="fa-solid fa-user-tie w-4 text-center flex-shrink-0 text-base text-blue-800"></i>
