...
class UpdateAttendanceDeviceRequest extends FormRequest
{
    ...
    {
        $deviceId = $this->route('attendance_device');
        ...
        return [
            ...
            'device_code'       => [
                ...
                'string',
                'max:50',
                Rule::unique('attendance_devices', 'device_code')->ignore($deviceId),
            ],
            ...
            'serial_number'     => [
                ...
                'string',
                'max:100',
                Rule::unique('attendance_devices', 'serial_number')->ignore($deviceId),
            ],
