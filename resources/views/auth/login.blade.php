<x-guest-layout>
    <div
        ...
        <div
            class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-blue-800 to-slate-900 p-12 flex-col justify-between relative overflow-hidden">
