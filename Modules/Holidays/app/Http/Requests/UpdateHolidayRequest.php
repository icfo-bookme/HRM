...
class UpdateHolidayRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'holiday_type'    => 'sometimes|required|in:Public,Government,Company,Optional,Religious,Festival',
            'applicable_to'   => 'sometimes|required|in:All,Specific,Branch,Department',
