        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2">
                ...
                @if($latestNotice)
                    ...
                    @endphp
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300 h-full {{ $latestNotice->is_pinned ? 'ring-2 ring-blue-300 ring-offset-1' : '' }}">
                        @if($latestNotice->is_pinned)
                            <div class="bg-gradient-to-r from-blue-700 via-blue-900 to-blue-950 px-5 py-2 flex items-center gap-2">
                        ...
                        <div class="p-6">
                            <div class="flex items-start justify-between">
                                ...
                                <a href="{{ route('notice.list') }}" class="text-xs text-blue-600 hover:text-blue-800 underline whitespace-nowrap">View All Notices</a>
                            </div>
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-lg transition-all duration-300">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 text-blue-700 text-xs font-medium rounded-lg border border-blue-200">
                        <i class="fas fa-calendar-week text-[10px]"></i> This Week
                    </span>
                </div>
                {{-- Chart Placeholder with bars that change --}}
                <div class="relative h-48 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-100 flex items-center justify-center overflow-hidden">
                    <div class="absolute inset-0 flex items-end px-4 pb-4 gap-2" id="attendanceBars">
                        ...
                        @foreach ($weeklyHeights as $h)
                            <div class="flex-1 bg-blue-400/30 rounded-t-md transition-all duration-500" style="height: {{ $h }}%"></div>
                        @endforeach
                    </div>
