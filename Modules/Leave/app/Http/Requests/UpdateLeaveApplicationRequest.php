...
class UpdateLeaveApplicationRequest extends FormRequest
{
    ...
    {
        $applicationId = $this->route('leave_application');
        ...
        return [
            ...
            'application_no' => [
                ...
                'string',
                'max:30',
                Rule::unique('leave_applications', 'application_no')->ignore($applicationId),
            ],
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            $excludeId = $this->route('leave_application');

            if ($employeeId && $fromDate && $toDate) {
                // Check for overlapping leave applications
                $overlapping = LeaveApplication::where('employee_id', $employeeId)
